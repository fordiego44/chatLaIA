		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title chat",
									"targetURL": "#riverconchat-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"riverconchat-display": {
								"semanticObject": "riverconchat",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rivercon.chat",
									"url": sap.ui.require.toUrl("rivercon/chat")
								}
							}
						}
					}
